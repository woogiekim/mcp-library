...
export function UseCaseCard({ useCase }: Props) {
  ...
  return (
    <Link
      ...
      className={`group block rounded-2xl border border-[#2A3042] bg-[#161B27] p-5 shadow-sm transition-all duration-200 card-hover hover:border-violet-500/40 hover:shadow-lg ${style.glow}`}
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 space-y-2 min-w-0">
          ...
          <h3 className="font-semibold text-slate-200 group-hover:text-violet-300 transition-colors leading-snug">
            {useCase.title}
          </h3>
